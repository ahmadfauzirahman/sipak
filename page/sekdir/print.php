...
<div class="row">
    <table>
        ...
        <tr>
            ...
            <td>
                <img src="assets/img/logo_1.png" style="height: 110px;">
            </td>
            <td style="width: 515px;">
        <center>
            <font face="Times New Roman" size="5" style="font-weight: bold;"><p>Kuliah Kerja Nyata 2017<br></font>
                <font face="Times New Roman" size="4">UNIVERSITAS ISLAM SULTAN SYARIF QASIM <br> DESA TEMUSAI <br></font>
                <font face="Times New Roman" size="3"> RIAU</p></font>

            <font face="Times New Roman" size="1"><p>Melayani Masyarakat<br>Jl. Bunga Raya - Sungai Pakning , Kota Siak Sri Indrapura, Riau <br> Website : http://riau.siak.go.id, Fax : (0761) - 38006</font>
        ...
        <tr>
            ...
            <td colspan="3" style="width: 400px;padding-right: 20px">
                <font face="Times New Roman" size="3"><p style=" text-align:justify;line-height: 1.5;"><span style="display:inline-block; width: 30;"></span>Yang bertanda tangan di bawah ini Bapak Penghulu Desa Temusai dengan ini memberi tugas kepada:<br></p></font>
                ...
                <p style=" text-align:justify;line-height: 1.5;">
                    <span style="display:inline-block; width: 30;"></span>Demikian surat tugas ini dibuat, agar yang bersangkutan melaksanakan tugas dengan baik dan penuh tanggung jawab.</p></font><br>

                <font face="Times New Roman" size="3">
                <p style=" text-align:justify;-webkit-margin-after: 0px;" line-height: 1.5;>
                   <span style="display:inline-block; width: 440;"></span>Dikeluarkan di : Temusai
                <p style="text-decoration: underline;text-align:justify;-webkit-margin-after: 0px;"><span style="display:inline-block; width: 440;"></span>Pada tanggal : <?php echo tanggal_indo(@$_POST['tgl_surat']); ?></p>
                <p><span style="display:inline-block; width: 440;"></span><?php if (@$_POST['ttd'] == "Penghulu Desa") {
                        echo'Penghulu Desa,';
                    } else {
                        echo 'an.Kerani Desa,';
                        if (@$_POST['ttd'] == "Kerani Desa") {
                            echo'<br><span style="display:inline-block; width: 440;">
                        </span>Kerani Desa';
                        } else if (@$_POST['ttd'] == "Kerani Desa") {
                            echo'<br><span style="display:inline-block; width: 440;"></span>Kerani Desa';
                        } else if (@$_POST['ttd'] == "Kerani Desa") {
                            echo'<br><span style="display:inline-block; width: 440;"></span>Kerani Desa';
                        }
                    }
                ...
                <font face="Times New Roman" size="3"><p style="text-decoration: underline;text-align:justify;-webkit-margin-after: 0px;"><span style="display:inline-block; width: 440;"></span><?php if (@$_POST['ttd'] == "Penghulu Desa") {
