...
$sql = "SELECT * FROM laporan WHERE status_lap='Menunggu Persetujuan Direktur'";
                                    ...
                                    ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center" width="16%">
                                                <a href="data/setuju2_dir.php?id_lap=<?php echo $x['id_lap']; ?>&aksi=setuju" onClick="return confirm('Setujui Laporan <?php echo $y['nama_keg'];?>?')"><button type="button" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-ok"></span><strong> SETUJU</strong>
                                                </button></a>
                                                <a href="data/setuju2_dir.php?id_lap=<?php echo $x['id_lap']; ?>&aksi=tolak" onClick="return confirm('Tolak Laporan <?php echo $y['nama_keg'];?>?')"><button type="button" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span><strong> TOLAK</strong>
                                                </button></a>
                                            </td>
                                        </tr>
