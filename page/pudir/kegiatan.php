...
$sql = "SELECT * FROM kegiatan WHERE status_keg='Menunggu Persetujuan Pudir'";
                    ...
                    <tbody>
                        ...
                        ?></td>
                                ...
                                <td class="center" width="16%">
                                    <a href="data/setuju_pudir.php?id_keg=<?php echo $x['id_keg']; ?>&aksi=setuju" onClick="return confirm('Setujui Kegiatan <?php echo $x['nama_keg']; ?>?')"><button type="button" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-ok"></span><strong> SETUJU</strong>
                                        </button></a>
                                    <a href="data/setuju_pudir.php?id_keg=<?php echo $x['id_keg']; ?>&aksi=tolak" onClick="return confirm('Tolak Kegiatan <?php echo $x['nama_keg']; ?>?')"><button type="button" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span><strong> TOLAK</strong>
                                        </button></a>
                                </td>
                            </tr>
